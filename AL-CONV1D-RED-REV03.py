...
Conv1     = Conv1D(filters=325, kernel_size=16,  strides= 8, activation='relu')(My_Input)
Conv2     = Conv1D(filters=110, kernel_size=8, strides= 4, activation='relu')(Conv1)
AVG1      = AveragePooling1D()(Conv2)
Conv3     = Conv1D(filters=36, kernel_size=8, strides= 1, activation='relu')(AVG1)
